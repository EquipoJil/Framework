...
public class PersonaController {
    ...
    @GetMapping("/personas")
    public List<Persona> getAllPersonas() {return personaRepository.findAll();
    }
...
//    }
    ...
    public Persona updatePersona(@PathVariable(value = "id") Long personaId,
        ...
        persona.ciudad = personaDetails.ciudad;
        persona.curp = personaDetails.curp;
        persona.correo = personaDetails.correo;

        Persona updatedPersona = personaRepository.saveAndFlush(persona);
